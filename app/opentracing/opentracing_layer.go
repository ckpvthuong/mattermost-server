...
func (a *OpenTracingAppLayer) GetTeamsAdminForUser(userId string) ([]*model.Team, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetTeamsAdminForUser")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetTeamsAdminForUser(userId)
...
func (a *OpenTracingAppLayer) GetTeamsForUserWithOptions(userId string, options model.GetTeamsOptions) ([]*model.Team, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetTeamsForUserWithOptions")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetTeamsForUserWithOptions(userId, options)
