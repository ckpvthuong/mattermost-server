...
func init() {
	...
	SampleDataCmd.Flags().Int("posts-per-channel", 20, "The number of sample post per channel.")
	SampleDataCmd.Flags().Int("direct-channels", 5, "The number of sample direct message channels.")
